...
<!-- navbar -->
  ...
  <div class="container card" id="contact">
            <h1 class="text-center" style="margin-top: 25px;">DATA ORDER</h1>
                <div class="card-body">
                    <a href="order_history.php" class="btn btn-success"> Orders History</a>
                        ...
                        <?php 
                          ...
                          if(mysqli_num_rows($orders) > 0){
                            ...
                            <tr>
                                ...
                                <td style="text-align:center"><?=$item['created_on']?></td>
                                <td><div align="center">
                                      <a href="viewOrder.php?t=<?= $item['tracking_no']; ?>" class="btn btn-warning">View Details Order</a>
                                  </div>
                                </td>
                            </tr>
                        <?php
