...
session_start();
require "koneksi.php";
    $listkategori = mysqli_query($connect, "SELECT * FROM produk_kategori");

    // get produk by nama produk
    if(isset($_GET['keyword'])){
        $listproduk = mysqli_query($connect, "SELECT * FROM update_produk WHERE produk_name LIKE '%$_GET[keyword]%'");
    }
    // get produk by kategori
    else if (isset($_GET['kategori'])) {
        $listprodukid = mysqli_query($connect, "SELECT id_kategori FROM produk_kategori WHERE kategori='$_GET[kategori]'");
        $kategoriid = mysqli_fetch_array($listprodukid);
        $listproduk = mysqli_query($connect, "SELECT * FROM update_produk WHERE id_kategori = '$kategoriid[id_kategori]'");
    }
    // get produk default
    else{
        $listproduk = mysqli_query($connect, "SELECT * FROM update_produk");
    }

    $countData = mysqli_num_rows($listproduk); 
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="banner2">
        <div class="content2">
            ...
            <p>Produk Terlengkap dan harga Terbaik</p>
            <div id="bannerbtn2"><a href="produk.php" class="btn btn-outline-primary">SHOP NOW</a></div>
        </div>
    </div>
    <!-- banner -->
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-3 mb-5">
                <h3>Kategori</h3>
                <ul class="list-group">
                    <?php while ($kategori = mysqli_fetch_array($listkategori)) {?>
                    <a class="no-decoration" href="produk.php?kategori=<?php echo $kategori['kategori'] ?>">
                        <li class="list-group-item"><?php echo $kategori['kategori']; ?></li>
                    </a>
                <?php } ?>
                </ul>
            </div>
            <div class="col-lg-9">
                ...
                <div class="row">
                    ...
                    <?php }
                    while($produk = mysqli_fetch_array($listproduk)){ ?>
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            <a href="detail_produk.php?produk_id=<?php echo $produk['produk_id']; ?>" style="color: black; text-decoration: none;">
                            <div class="image-box">
                                <img src="img/<?php echo $produk['produk_image']; ?>" class="card-img-top">
                            </div>
                            <div class="card-body">
                                <h4 class="card-title"><?php echo $produk['produk_name']; ?></h4>
                                <p class="card-text text-harga">Rp <?php echo number_format($produk['produk_price']); ?></p>
                            </div>
                        </a>
                        </div>
                    </div> 
