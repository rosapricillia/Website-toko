...
<!-- navbar -->
  ...
  <div class="container card" id="contact">
            <h3 style="margin-top: 25px;" class="text-center fw-bold">DETAIL ORDER</h3>
            <hr>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <table class="table">
                                ...
                                <tbody>
                                <?php
                                    $order_query = "SELECT o.orders_id as oid, o. tracking_no, o.login_id, oi.*, oi.jumlah as orderjml, p.* FROM orders o, order_item oi, update_produk p WHERE oi.orders_id=o.orders_id AND p.produk_id=oi.produk_id AND o.tracking_no='$tracking_no'"; 
                            ...
                            <form action="proses.php" method="POST">
                                ...
                                <select name="order_status" class="form-select">
                                    <option value="0" <?= $data['status'] == 0?"selected":""?>>Sedang Proses</option>
