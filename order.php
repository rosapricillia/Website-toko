            ...
            foreach ($items as $citem) {
               ...
               <div class="mb-1 border">
                 <div class="row align-items-center">
                   <div class="col-md-2">
                     <img src="img/<?= $citem['produk_image']?>" alt="Image" width="100" height="100">
                   </div>
                   <div class="col-md-2">
                     <label><?= $citem['produk_name']?></label>
                   </div>
                   <div class="col-md">
                     <label>Rp <?= number_format($citem['produk_price']);?></label>
                   </div>
                   <div class="col-md">
                     <label>x <?= $citem['jumlah']?></label>
                   </div>
                   <div class="col-md">
                     <label> Rp <?php echo number_format($citem["jumlah"] * $citem["produk_price"]); ?></label>
                   </div>
                 </div>
               </div>
               <?php
             ...
             ?>
             <h4>Total : <span class="float-end">Rp <?= number_format($total); ?></span></h4>
        </div>
      </div>
    </div>
          ...
          <section class="order-form">
            ...
            <form action="proses.php" method="post">
              ...
              <div class="col-md-auto">
                <label class="my-2 fw-bold">Nama</label>
                   <input type="text" name="nama" required placeholder="Masukkan Nama" class="form-control">
                <label class="my-2 fw-bold">No Telpon</label>
                   <input type="number" name="no_telp" required placeholder="Masukkan Nomor Telpon" class="form-control">
                <label class="my-2 fw-bold">Kode Pos</label>
                   <input type="number" name="kode_pos" required placeholder="Masukkan Kode Pos" class="form-control">
                    <label class="my-2 fw-bold">Alamat</label>
                    <textarea class="form-control" rows="3" name="alamat" placeholder="Masukkan alamat" required=""></textarea>
              </div>
              
              </div>
              <div class="form-group">        
                <div class="col-sm-offset-3 col-sm-9 my-3">
