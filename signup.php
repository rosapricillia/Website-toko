            ...
            <div class="row">
                ...
                <div class="col-md-8" id="side2">
                   ...
                   <?php 
                    ...
                    ?>
                        <input type="text" name="login_name" required placeholder="enter your name">
                        <input type="email" name="login_email" required placeholder="enter your email">
                        <input type="password" name="login_pw" required placeholder="enter your password">
                        <input type="password" name="cpassword" required placeholder="confirm your password">
                        <input type="number" name="login_mobile" required placeholder="enter your mobile number">
                    <div id="login"><button type="submit" name="register">SIGN UP</button></div>
                  </form>
                </div>
            </div>
        </div>
